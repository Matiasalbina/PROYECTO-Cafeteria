      ...
      <div className="bg-white w-full flex flex-col gap-5 px-3 py-6 md:px-16 lg:px-28 md:flex-row text-[#161931]">
        ...
        <aside className="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
          <div className="sticky flex flex-col gap-2 py-8 px-4 text-sm border-r border-negro-100 top-12">
            <span className="flex items-center px-3 py-2.5 font-bold bg-white text-negro-900 border rounded-full">
              Mi cuenta
            </span>
            <Link
              to="/acceso-seguridad"
              className="flex items-center px-3 py-2.5 font-semibold hover:text-negro-900 hover:border hover:rounded-full"
            >
              Acceso y seguridad
            </Link>
            <Link
                ...
                <div className="items-center mt-8 sm:mt-14 text-[#202142]">
                  ...
                  <div className="flex flex-col items-center w-full mb-2 space-x-0 space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0 sm:mb-6">
                    <div className="w-full">
                      <label
                        htmlFor="first_name"
                        className="block mb-2 text-sm font-medium text-negro-900"
                      >
                        Primer nombre*
                      </label>
                      <input
